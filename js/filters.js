let filterButtons = document.querySelectorAll('.project-area__filter');
let projects = document.querySelectorAll('.project-area__item');
...
filterButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        projects.forEach(project => {
            let projectCategory = project.querySelector('.project-area__description').textContent;
